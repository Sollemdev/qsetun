...
1. **`01_Cardiac_Arrhythmia_ST7789`** — Turnkey clinical arrhythmia monitor on LilyGO T-Display (ST7789 IPS 135x240) running a 60 FPS hardware oscilloscope sweep.
